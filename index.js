...
async function startAdrian() {
    ...
    const conn = connConnect({
        ...
        browser: ['NCBOTZ-MD','Safari','1.0.0'],
   ...
   // anticall auto block
    ...
    conn.ev.on('messages.upsert', async chatUpdate => {
        ...
        if (mek.key.id.startsWith('NCBOTZ-MD')) return
				...
				conn.sendMessage(res.id, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: `${namaowner}`,
                            thumbnailUrl: ppgroup,
                            sourceUrl: "https://instagram.com/nanocendysstore",
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
